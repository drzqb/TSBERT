...
PARAMS_decay_steps = PARAMS_epochs * ceil(PARAMS_per_save / PARAMS_acum_step)
PARAMS_warmup_steps = 1 * ceil(PARAMS_per_save / PARAMS_acum_step)
PARAMS_lr = 2.0e-5
PARAMS_patience = 3
...
PARAMS_model = "SBERT_ACUM_lcqmc_simplified"
...
class USER():
    ...
    def train(self):
        ...
        newoptimizer = extend_with_gradient_accumulation_v2(AdamWeightDecay)
        ...
        if PARAMS_mode == 'train0':
            ...
            optimizer = newoptimizer(grad_accum_steps=PARAMS_acum_step, learning_rate=warmup_schedule,
