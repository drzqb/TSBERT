...
PARAMS_model = "SimCSE_ACUM_lcqmc_sp_simplified"
...
class USER():
    ...
    def build_model_train(self):
        ...
        # tf.keras.utils.plot_model(model, to_file="SimCSE_ACUM_train_unsupervised_sp_simplified.jpg", show_shapes=True,
        #                           dpi=900)
    ...
    def build_model_predict(self):
        ...
        # tf.keras.utils.plot_model(model, to_file="SimCSE_ACUM_predict_unsupervised_sp_simplified.jpg", show_shapes=True,
        #                           dpi=900)
    ...
    def train(self):
        ...
        optimizer = newoptimizer(grad_accum_steps=PARAMS_accum_step, learning_rate=PARAMS_lr)
