...
class USER():
    ...
    def build_model_train(self):
        ...
        # tf.keras.utils.plot_model(model, to_file="SimCSE_train_unsupervised_sp.jpg", show_shapes=True, dpi=900)
    ...
    def build_model_predict(self):
        ...
        # tf.keras.utils.plot_model(model, to_file="SimCSE_predict_unsupervised_sp.jpg", show_shapes=True, dpi=900)
